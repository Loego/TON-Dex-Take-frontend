...
export const LiquidityPanel = () => {
  ...
  return (
    <div className="mx-auto px-4 lg:w-1/2 flex flex-col p-5 container pt-28">
      <div className=" rounded-t-2xl bg-[#1E2939] border border-[#2B2649] py-6 px-8 flex flex-row justify-between">
        <div>
      ...
      <div className=" border-x bg-[#242424] border border-[#2B2649] px-12 py-7">
        <button className=" bg-[#1f93d6] w-full" onClick={handleAddLiquidity}>
          {" "}
          + Add Liquidity
        </button>
      </div>
      <div className="rounded-b-2xl bg-[#1E2939] border border-[#2B2649] py-6 px-8">
