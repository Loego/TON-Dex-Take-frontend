  ...
  return (
    <div className="flex justify-center md:pt-40 pt-10 md:pb-0 pb-24 items-center h-full w-full">
      <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-6">
        <div className="h-[150px] w-[350px] rounded-[12px] relative flex justify-between bg-white dark:bg-[#111111CC] border-[1px] dark:border-[#353535] border-[#BFD9FF] container-shadow">
