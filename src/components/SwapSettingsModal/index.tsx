...
function SlippageTolerance() {
  ...
  return (<div className={styles.item}>
    <div className=" flex flex-row flex-nowrap items-center gap-2"><InformationCircleIcon className="h-6 w-6 text-[#1FC7D4]" /><h5>Slippage Tolerance</h5></div>
...
function TxDeadline() {
  ...
  return (<div className={styles.item}>
    <div className=" flex flex-row flex-nowrap items-center gap-2"><InformationCircleIcon className="h-6 w-6 text-[#1FC7D4]" /><h5>Tx Deadline</h5></div>
...
function ExpertMode() {
  ...
  return (<div className={styles.itemSmall}>
    <div className=" flex flex-row flex-nowrap items-center gap-2"><InformationCircleIcon className="h-6 w-6 text-[#1FC7D4]" /><h5>Expert Mode</h5></div>
...
function Multihops() {
  ...
  return (<div className={styles.itemSmall}>
    <div className=" flex flex-row flex-nowrap items-center gap-2"><InformationCircleIcon className="h-6 w-6 text-[#1FC7D4]" /><h5>Enable Multihops</h5></div>
